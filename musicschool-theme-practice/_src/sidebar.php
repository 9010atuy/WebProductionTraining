<div class="c-col-side">
    ...
    <div class="c-blog-section c-blog-section--border">
        ...
        <form action="<?php echo get_template_directory_uri(); ?>/search.html" class="c-blog-section__form">
            <input type="search" class="c-blog-section__form-input">
            <input type="image" src="<?php echo get_template_directory_uri(); ?>/images/common/icon-search.svg" class="c-blog-section__form-submit">
        </form>
    </div>
    <div class="c-blog-section">
        <p class="c-blog-section-name c-blog-section-name--side">おすすめの記事</p>
        <a href="" class="c-blog-section__recommend ">
            <div class="c-blog-section__recommend-img"></div>
            <p>タイトルが入ります。タイトル</p>
        </a>
        <a href="" class="c-blog-section__recommend">
            <div class="c-blog-section__recommend-img"></div>

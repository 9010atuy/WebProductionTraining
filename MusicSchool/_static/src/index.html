...
<body>
    ...
    <div class="c-hamburger-menu">
        <nav class="hamburger-nav">
            <ul class="hamburger-list">
                ...
                <li><a href="./result_list.html" class="c-hamburger-item hamburger-trigger">卒業実績</a></li>
            </ul>
        </nav>
    </div>
    ...
    <section id="about">
        <div class="main-wrapper">
            ...
            <img src="./img/icon/semicircle-sp.svg" alt="半円アイコン" class="no-pc about-semicircle-icon">
            <img src="./img/icon/semicircle.svg" alt="半円アイコン" class="pc about-semicircle-icon">
            <div class="about__vision">
                ...
                <img src="./img/icon/up-arrow-red.svg" alt="上矢印赤" class="about-vision-icon__arrow">
                <img src="./img/icon/circle-red.svg" alt="上矢印赤" class="about-vision-icon__circle">
            </div>
        </div>
    ...
    <section id="reason" class="main-wrapper">
        ...
        <div class="reason__item">
            <div class="reason__img-container">
                <img src="./img/SP/top/reason01.png" alt="reason01" class="reason__img no-pc" srcset="./img/SP/top/reason01.png 1x,
                ./img/SP/top/reason01@2x.png 2x">
                <img src="./img/PC/top/reason01.png" alt="reason01" class="reason__img pc" srcset="./img/PC/top/reason01.png 1x,
                ./img/PC/top/reason01@2x.png 2x">
            </div>
        ...
        <div class="reason__item">
            <div class="reason__img-container">
                <img src="./img/SP/top/reason02.png" alt="reason02" class="reason__img no-pc" srcset="./img/SP/top/reason02.png 1x,
                ./img/SP/top/reason02@2x.png 2x">
                <img src="./img/PC/top/reason02.png" alt="reason02" class="reason__img pc" srcset="./img/PC/top/reason02.png 1x,
                ./img/PC/top/reason02@2x.png 2x">
            </div>
            <div class="reason__desc-container">
        ...
        <div class="reason__item">
            <div class="reason__img-container">
                <img src="./img/SP/top/reason03.png" alt="reason03" class="reason__img no-pc" srcset="./img/SP/top/reason03.png 1x,
                ./img/SP/top/reason03@2x.png 2x">
                <img src="./img/PC/top/reason03.png" alt="reason03" class="reason__img pc" srcset="./img/PC/top/reason03.png 1x,
                ./img/PC/top/reason03@2x.png 2x">
            </div>
            <div class="reason__desc-container">
                <h2 class="reason__title reason__not-first-title">
    ...
    <section id="introduction" class="main-wrapper">
        ...
        <div class="introduction__contents">
            <div class="introduction__shape">
                <img src="./img/icon/down-arrow-red.svg" alt="down-arrow" class="introduction__arrow no-pc">
                <img src="./img/icon/down-arrow-red-pc.svg" alt="down-arrow" class="introduction__arrow pc">
                <div class="introduction__circle__container">
                    <img src="./img/icon/circle-red-single.svg" alt="circle-red-single" class="introduction__circle">
                    <img src="./img/icon/circle-red-single.svg" alt="circle-red-single" class="introduction__circle">
                    <img src="./img/icon/circle-red-single.svg" alt="circle-red-single" class="introduction__circle">
                    <img src="./img/icon/circle-red-single.svg" alt="circle-red-single" class="introduction__circle">
                </div>
    ...
    <section id="faq" class="main-wrapper">
        ...
        <div class="faq__contents">
            <div class="accordion__item c-accordion-toggle js-accordion-toggle accordion__flex">
                <img src="./img/icon/question.svg" alt="question-icon" class="accordion__question-icon">
            ...
            <div class="accordion__collapse u-font--red u-font--bold">
                <div class="accordion__collapse__inner accordion__flex">
                    <img src="./img/icon/answer.svg" alt="answer-icon" class="accordion__answer-icon">
    ...
    <section id="news">
        <div class="main-wrapper">
            ...
            <table class="news__table">
                <tr>
                    <td class="news__date u-font--white u-font--bold"><a
                            href="./notice_details.html">2022.01.01&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
                    <td class="news__text u-font--white u-font--bold"><a
                            href="./notice_details.html">卒業生のケニーさんによるyoutubeサムネイル講座が始まります。</a></td>
                </tr>
                <tr>
                    <td class="news__date u-font--white u-font--bold"><a
                            href="./notice_details.html">2022.01.01&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
                    <td class="news__text u-font--white u-font--bold"><a
                            href="./notice_details.html">専用アプリから予約できるようになりました。</a></td>
                </tr>
                <tr>
                    <td class="news__date u-font--white u-font--bold"><a
                            href="./notice_details.html">2022.01.01&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
                    <td class="news__text u-font--white u-font--bold"><a
                            href="./notice_details.html">あけましておめでとうございます。</a></td>
                </tr>
                <tr>
                    <td colspan="2" class="news__forward u-font--white"><a href="./notice_list.html">お知らせ一覧へ</a></td>
                </tr>
            </table>
        </div>
    </section>
    <section id="blog">
        <div class="main-wrapper">
                ...
                <div class="c-card blog__card">
                    <a href="./blog_details.html">
                        <div class="c-card__img-container">
                            ...
                            <img src="./img/SP/top/blog01.png"
                                srcset="./img/SP/top/blog01.png 1x, ./img/PC/top/blog01@2x.png 2x" alt="ブログ画像01"
                                class="c-card__img blog__card__img no-pc">
                            <img src="./img/PC/top/blog01.png"
                                srcset="./img/PC/top/blog01.png 1x, ./img/PC/top/blog01@2x.png 2x" alt="ブログ画像01"
                                class="c-card__img blog__card__img pc">
                        </div>
                ...
                <div class="c-card blog__card">
                    <a href="./blog_details.html">
                        <div class="c-card__img-container">
                            ...
                            <img src="./img/SP/top/blog02.png"
                                srcset="./img/SP/top/blog02.png 1x, ./img/SP/top/blog02@2x.png 2x" alt="ブログ画像02"
                                class="c-card__img blog__card__img no-pc">
                            <img src="./img/PC/top/blog02.png"
                                srcset="./img/PC/top/blog02.png 1x, ./img/PC/top/blog02@2x.png 2x" alt="ブログ画像02"
                                class="c-card__img blog__card__img pc">
                        </div>
                ...
                <div class="c-card blog__card">
                    <a href="./blog_details.html">
                        <div class="c-card__img-container">
                            ...
                            <img src="./img/SP/top/blog03.png"
                                srcset="./img/SP/top/blog03.png 1x, ./img/SP/top/blog03@2x.png 2x" alt="ブログ画像03"
                                class="c-card__img blog__card__img no-pc">
                            <img src="./img/PC/top/blog03.png"
                                srcset="./img/PC/top/blog03.png 1x, ./img/PC/top/blog03@2x.png 2x" alt="ブログ画像03"
                                class="c-card__img blog__card__img pc">
                        </div>
            ...
            <a href="./blog_list.html" class="blog__forward">ブログ一覧へ</a>
        </div>
        <div class="u-pos-fixed u-bottom-0 u-right-0 js-fixed-btn-pc">
            ...
            <button class="c-button--red c-button--mid u-mt-31"
        ...
        <div class="main-wrapper footer-wrapper">
            <nav class="footer__nav">
                <ul>
                    ...
                    <li><a href="./blog_list.html" class="u-font--white u-font--bold footer__nav__itemlink">ブログ</a></li>
